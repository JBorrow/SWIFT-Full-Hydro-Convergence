...
try:
    glass_L = h5py.File(sys.argv[1], "r")
    glass_R = h5py.File(sys.argv[2], "r")
except:
    print("""
    Please provide two HDF5 file names, firstly your low resolution glass,
    and secondly your high resolution glass. If you did, and you're still getting
    this message, something else is wrong.""")
