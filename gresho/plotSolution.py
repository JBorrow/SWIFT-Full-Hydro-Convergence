...
sim = load(f"gresho_{snap:04d}.hdf5")
...
# Bin the data
x_bin_edge = np.linspace(0.0, 0.7, 50)
...
ylim = dict(diff=(0.0, None), visc=(0.0, None), v_phi=(-0.05, None))
...
fig.savefig("GreshoVortex.pdf", dpi=300)
